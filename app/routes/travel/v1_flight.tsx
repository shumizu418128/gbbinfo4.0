import type { Route } from "./+types/v1_flight.js";
import { V1FlightContent } from "../../pages/travel/V1FlightContent.js";
...
export const meta = ({ data }: Route.MetaArgs) => {
  const env = data?.env;
  return createMeta(env, "3. 飛行機編 | ワルシャワへ行こう");
};

export const TravelV1Flight = () => {
  ...
  return (
    <>
      ...
      <HeroImage yearWithCountry={yearWithCountry} subtitle="3. 飛行機編" />
      <V1FlightContent locale={locale} />
      <FooterMenu latestYearWithCountry={latestYearWithCountry} />
    </>
  );
};

export default TravelV1Flight;
