import type { Route } from "./+types/wildcards.js";
import { WildcardsContent } from "../../pages/2026/WildcardsContent.js";
...
export const meta = ({ data }: Route.MetaArgs) => {
  const env = data?.env;
  const title = `GBB ${YEAR} ${m.wildcard_list({ Wildcard: "Wildcard" })}`;
...
export const Wildcards = () => {
  ...
  return (
    <>
      ...
      <HeroImage yearWithCountry={yearWithCountry} subtitle={m.wildcard_list({ Wildcard: "Wildcard" })} />
      <WildcardsContent locale={locale} year={YEAR} />
