import type { Route } from "./+types/studio_competition.js";
import { StudioCompetitionContent } from "../../pages/2026/StudioCompetitionContent.js";
...
export const meta = ({ data }: Route.MetaArgs) => {
  const env = data?.env;
  const title = `GBB ${YEAR} Studio Competition`;
  return createMeta(env, title);
};

export const StudioCompetition = () => {
  ...
  return (
    <>
      ...
      <HeroImage yearWithCountry={yearWithCountry} subtitle="Studio Competition" />
      <StudioCompetitionContent locale={locale} year={YEAR} />
      <FooterMenu latestYearWithCountry={latestYearWithCountry} />
    </>
  );
};

export default StudioCompetition;
