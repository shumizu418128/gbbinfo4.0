import type { Route } from "./+types/stream.js";
import { StreamContent } from "../../pages/2026/StreamContent.js";
...
export const meta = ({ data }: Route.MetaArgs) => {
  const env = data?.env;
  const title = `GBB ${YEAR} ${m.livestream()}`;
...
export const Stream = () => {
  ...
  return (
    <>
      ...
      <HeroImage yearWithCountry={yearWithCountry} subtitle={m.livestream()} />
      <StreamContent locale={locale} year={YEAR} />
