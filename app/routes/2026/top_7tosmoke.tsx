import type { Route } from "./+types/top_7tosmoke.js";
import { Top7toSmokeContent } from "../../pages/2026/Top7toSmokeContent.js";
...
export const meta = ({ data }: Route.MetaArgs) => {
  const env = data?.env;
  const title = `GBB ${YEAR} 7toSmoke`;
  return createMeta(env, title);
};

export const Top7toSmoke = () => {
  ...
  return (
    <>
      ...
      <HeroImage yearWithCountry={yearWithCountry} subtitle="7toSmoke" />
      <Top7toSmokeContent locale={locale} year={YEAR} />
      <FooterMenu latestYearWithCountry={latestYearWithCountry} />
    </>
  );
};

export default Top7toSmoke;
